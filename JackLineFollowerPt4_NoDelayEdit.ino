  ...
  //Move forward if on white line and not at intersection
    ...
    //left sensor of middle is adc2_buf[3]
        if( PWM_M2_VALUE > 55 ) {
          ...
          PWM_M1_VALUE = PWM_M1_VALUE -0.5;
        }
        //else {
          M2_forward(PWM_M2_VALUE + 0.55); //changed from +2 to +4 //removed
        ...
        //M1_forward(PWM_M1_VALUE); //added
          ...
          if(PWM_M1_VALUE > 55 ) {
            //M2_forward(PWM_M2_VALUE - 2);
              PWM_M2_VALUE = PWM_M2_VALUE -0.5;

          }
          //else {
            M1_forward(PWM_M1_VALUE + 0.5); //changed from +1 to +2 //removed
          //}

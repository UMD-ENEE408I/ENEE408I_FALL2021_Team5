...
with open('Arrayfile.csv', newline='') as csvfile:
    Command_Array = list(csv.reader(csvfile))
...
async def sendData(client):
    ...
    userInput = Command_Array[Command_Count][1]

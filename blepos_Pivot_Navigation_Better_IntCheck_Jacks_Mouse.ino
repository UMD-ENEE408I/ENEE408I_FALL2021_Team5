...
const char* statusCharacteristicUuid = "19d10001-e8f2-537e-4f6c-d104768a1214";
...
BLEByteCharacteristic statusCharacteristic(statusCharacteristicUuid, BLERead | BLEWrite | BLENotify);
BLEByteCharacteristic xposCharacteristic(xposCharacteristicUuid, BLEWrite | BLENotify);
BLEByteCharacteristic yposCharacteristic(yposCharacteristicUuid, BLEWrite | BLENotify);
...
void moveCourseCorrect() {
  mouse_forward(FULL_SPEED_FORWARD + PIDvalue, (FULL_SPEED_FORWARD+3)- PIDvalue);
}
...
//________________________END BLUETOOTH__________________________
  ...
  MazeMap[5][5][0] = 'T';   //Mark the Node for the Start position location
  MazeMap[5][5][6] = 'V';   //Mark the Start Position to Visited
}
...
void sendPosition() {
  ...
  xposCharacteristic.writeValue(xpos);

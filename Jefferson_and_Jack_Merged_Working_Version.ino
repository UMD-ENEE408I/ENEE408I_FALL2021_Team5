...
const int LENGTH_AFTER_INT = 120; 
...
int MazeX = 25;  //Initial X Position for the MazeMap is the Center
int MazeY = 25;  //Initial Y Position for the MazeMap is the Center
char Direction = 'N';    //Initial Direction will always be assumed to be North
//////////////////////////////////////////////////////////////////////////////////////

//Forward
const unsigned int FULL_SPEED_FORWARD = 34;
...
const int BLACK = 685; //Changed to 685 from 680 for Testing. 

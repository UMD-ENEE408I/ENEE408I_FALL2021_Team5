...
const int LENGTH_AFTER_INT = 170;
...
void setup() {
  ...
  if (SCOUT_MODE) {
    String local_name = "SCOUT";
    local_name += String(SCOUT_NUM);
    BLE.setLocalName(local_name);
  }
  else {
    BLE.setLocalName("SOLVER");
  }
  ...
  scoutService.addCharacteristic(commandCharacteristic);
  ...
  //________________________SCOUT FOLLOW MODE INITIALIZATION_________________//
  isScout = false;
  isFollowing = false;

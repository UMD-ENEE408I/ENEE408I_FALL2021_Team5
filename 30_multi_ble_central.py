            ...
            async with BleakClient(d.address) as client:
                ...
                while True:
                    ...
                    if (atExit == False):  
                        ...
                        if (not scout1_init):
                            scout1_curr_command = encode_command(1, Command.READY)
                    ...
                    #
                        ...
                        global scouting_finished
                        scouting_finished = True
                        return 0 
                    break
                    ...
                    while True:
                        ...
                        if (is_command_empty(val)):
                            for r in range(Command_Counter):
                                ...
                                await client.write_gatt_char(COMMAND_CHAR_UUID, toSend, False)

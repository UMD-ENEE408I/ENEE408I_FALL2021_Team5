...
void MazeMapping(int* MazeX, int* MazeY, char Direction, bool atIntersection, bool atRight, bool atLeft, bool atExit, bool travelledUnitLength){
  switch (Direction){ 
    case 'N':
      *MazeY = *MazeY - 1; 
      break; 
...
void loop() {
  ...
  //Stop if at an intersection MUST IMPLEMENT HANDLE INTERSECTION
    ...
    MazeMapping(&MazeX, &MazeY, Direction, atIntersection, atRight, atLeft, atExit, travelledUnitLength); 
    mouse_right();

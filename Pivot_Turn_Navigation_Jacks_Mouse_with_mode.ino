...
#define DEBUG true //set this to true to only begin when connected to Serial monitor
...
#define ENABLE_MOVEMENT false //set this to true for the mouse to be able to move
